...
#ifndef ESET_FILE_SYSTEM_PARALLELPARSINGSCHEDULERTHREADFLAGS_H
#define ESET_FILE_SYSTEM_PARALLELPARSINGSCHEDULERTHREADFLAGS_H
...
#endif //ESET_FILE_SYSTEM_PARALLELPARSINGSCHEDULERTHREADFLAGS_H
